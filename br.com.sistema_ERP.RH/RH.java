...
public class RH {
    ...
    protected static void FolhaPagamento(Scanner scanner) {
        ...
        if (usuario instanceof Funcionario) {
            ...
            Gerente gerente = (Gerente) usuario;
            int dias_faltas = gerente.getNumeroFaltas();
            double proporcional = (dias_faltas / 20.0) * gerente.getSalario();
            System.out.println("Calculando folha de pagamento para " + gerente.getNome() + "...");
            System.out.println("Salário Bruto: " + gerente.getSalario());
            System.out.println("Número de faltas: " + dias_faltas);
            System.out.println("Desconto por faltas: " + proporcional);
            System.out.println("Salário final: " + (gerente.getSalario() - proporcional));
        } else {
